...
abstract class BaseUserStoryPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'ProjectId', 'Numero', 'Description', 'Value', 'Complexity', 'Ratio', 'CreatedAt', 'UpdatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'projectId', 'numero', 'description', 'value', 'complexity', 'ratio', 'createdAt', 'updatedAt', ),
        BasePeer::TYPE_COLNAME => array (UserStoryPeer::ID, UserStoryPeer::PROJECT_ID, UserStoryPeer::NUMERO, UserStoryPeer::DESCRIPTION, UserStoryPeer::VALUE, UserStoryPeer::COMPLEXITY, UserStoryPeer::RATIO, UserStoryPeer::CREATED_AT, UserStoryPeer::UPDATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'PROJECT_ID', 'NUMERO', 'DESCRIPTION', 'VALUE', 'COMPLEXITY', 'RATIO', 'CREATED_AT', 'UPDATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'project_id', 'numero', 'description', 'value', 'complexity', 'ratio', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ProjectId' => 1, 'Numero' => 2, 'Description' => 3, 'Value' => 4, 'Complexity' => 5, 'Ratio' => 6, 'CreatedAt' => 7, 'UpdatedAt' => 8, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'projectId' => 1, 'numero' => 2, 'description' => 3, 'value' => 4, 'complexity' => 5, 'ratio' => 6, 'createdAt' => 7, 'updatedAt' => 8, ),
        BasePeer::TYPE_COLNAME => array (UserStoryPeer::ID => 0, UserStoryPeer::PROJECT_ID => 1, UserStoryPeer::NUMERO => 2, UserStoryPeer::DESCRIPTION => 3, UserStoryPeer::VALUE => 4, UserStoryPeer::COMPLEXITY => 5, UserStoryPeer::RATIO => 6, UserStoryPeer::CREATED_AT => 7, UserStoryPeer::UPDATED_AT => 8, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'PROJECT_ID' => 1, 'NUMERO' => 2, 'DESCRIPTION' => 3, 'VALUE' => 4, 'COMPLEXITY' => 5, 'RATIO' => 6, 'CREATED_AT' => 7, 'UPDATED_AT' => 8, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'project_id' => 1, 'numero' => 2, 'description' => 3, 'value' => 4, 'complexity' => 5, 'ratio' => 6, 'created_at' => 7, 'updated_at' => 8, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, 8, )
    );
