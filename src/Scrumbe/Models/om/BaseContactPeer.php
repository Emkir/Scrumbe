...
use Scrumbe\Models\ContactPeer;
use Scrumbe\Models\map\ContactTableMap;
...
abstract class BaseContactPeer
{
    ...
    const OM_CLASS = 'Scrumbe\\Models\\Contact';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Scrumbe\\Models\\map\\ContactTableMap';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Email', 'Message', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'email', 'message', ),
        BasePeer::TYPE_COLNAME => array (ContactPeer::ID, ContactPeer::NAME, ContactPeer::EMAIL, ContactPeer::MESSAGE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'EMAIL', 'MESSAGE', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'email', 'message', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Email' => 2, 'Message' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'email' => 2, 'message' => 3, ),
        BasePeer::TYPE_COLNAME => array (ContactPeer::ID => 0, ContactPeer::NAME => 1, ContactPeer::EMAIL => 2, ContactPeer::MESSAGE => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'EMAIL' => 2, 'MESSAGE' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'email' => 2, 'message' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseContactPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Scrumbe\Models\map\ContactTableMap());
      }
    }
