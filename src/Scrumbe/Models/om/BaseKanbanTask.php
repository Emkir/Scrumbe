...
abstract class BaseKanbanTask extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Scrumbe\\Models\\KanbanTaskPeer';
    ...
    /**
     * The value for the task_position field.
     * @var        int
     */
    protected $task_position;
    ...
    /**
     * Get the [task_position] column value.
     *
     * @return int
     */
     ...
     * @return KanbanTask The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = KanbanTaskPeer::ID;
        }
    ...
    public function setTaskId($v)
    {
        ...
        if ($this->task_id !== $v) {
            $this->task_id = $v;
            $this->modifiedColumns[] = KanbanTaskPeer::TASK_ID;
        }
    ...
    public function setSprintId($v)
    {
        ...
        if ($this->sprint_id !== $v) {
            $this->sprint_id = $v;
            $this->modifiedColumns[] = KanbanTaskPeer::SPRINT_ID;
        }
    ...
    /**
     * Set the value of [task_position] column.
     *
     * @param  int $v new value
     * @return KanbanTask The current object (for fluent API support)
     */
    public function setTaskPosition($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->task_position !== $v) {
            $this->task_position = $v;
            $this->modifiedColumns[] = KanbanTaskPeer::TASK_POSITION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->task_position = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = KanbanTaskPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating KanbanTask object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = KanbanTaskPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = KanbanTaskQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                KanbanTaskPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(KanbanTaskPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(KanbanTaskPeer::TASK_ID)) {
            $modifiedColumns[':p' . $index++]  = '`task_id`';
        }
        if ($this->isColumnModified(KanbanTaskPeer::SPRINT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`sprint_id`';
        }
        if ($this->isColumnModified(KanbanTaskPeer::TASK_POSITION)) {
            $modifiedColumns[':p' . $index++]  = '`task_position`';
        }

        $sql = sprintf(
            'INSERT INTO `kanban_task` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`sprint_id`':
                        ...
                        break;
                    case '`task_position`':
                        $stmt->bindValue($identifier, $this->task_position, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = KanbanTaskPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = KanbanTaskPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['KanbanTask'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['KanbanTask'][$this->getPrimaryKey()] = true;
        $keys = KanbanTaskPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getTaskId(),
            $keys[2] => $this->getSprintId(),
            $keys[3] => $this->getTaskPosition(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setTaskPosition($arr[$keys[3]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(KanbanTaskPeer::ID)) $criteria->add(KanbanTaskPeer::ID, $this->id);
        if ($this->isColumnModified(KanbanTaskPeer::TASK_ID)) $criteria->add(KanbanTaskPeer::TASK_ID, $this->task_id);
        if ($this->isColumnModified(KanbanTaskPeer::SPRINT_ID)) $criteria->add(KanbanTaskPeer::SPRINT_ID, $this->sprint_id);
        if ($this->isColumnModified(KanbanTaskPeer::TASK_POSITION)) $criteria->add(KanbanTaskPeer::TASK_POSITION, $this->task_position);
    ...
    {
        $criteria = new Criteria(KanbanTaskPeer::DATABASE_NAME);
        $criteria->add(KanbanTaskPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of KanbanTask (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setTaskPosition($this->getTaskPosition());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return KanbanTask Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return KanbanTaskPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new KanbanTaskPeer();
        }
    ...
    public function getTask(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aTask === null && ($this->task_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aTask->addKanbanTasks($this);
             */
        }
    ...
    public function getSprint(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aSprint === null && ($this->sprint_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSprint->addKanbanTasks($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(KanbanTaskPeer::DEFAULT_STRING_FORMAT);
    }
