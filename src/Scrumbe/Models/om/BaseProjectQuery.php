 ...
 * @method ProjectQuery orderByCoverProject($order = Criteria::ASC) Order by the cover_project column
 * @method ProjectQuery orderByStartDate($order = Criteria::ASC) Order by the start_date column
 * @method ProjectQuery orderByEndDate($order = Criteria::ASC) Order by the end_date column
 ...
 * @method ProjectQuery groupByCoverProject() Group by the cover_project column
 * @method ProjectQuery groupByStartDate() Group by the start_date column
 * @method ProjectQuery groupByEndDate() Group by the end_date column
 ...
 * @method ProjectQuery innerJoinUserStory($relationAlias = null) Adds a INNER JOIN clause to the query using the UserStory relation
 *
 * @method ProjectQuery leftJoinLinkProjectUser($relationAlias = null) Adds a LEFT JOIN clause to the query using the LinkProjectUser relation
 * @method ProjectQuery rightJoinLinkProjectUser($relationAlias = null) Adds a RIGHT JOIN clause to the query using the LinkProjectUser relation
 * @method ProjectQuery innerJoinLinkProjectUser($relationAlias = null) Adds a INNER JOIN clause to the query using the LinkProjectUser relation
 *
 ...
 * @method Project findOneByCoverProject(string $cover_project) Return the first Project filtered by the cover_project column
 * @method Project findOneByStartDate(string $start_date) Return the first Project filtered by the start_date column
 * @method Project findOneByEndDate(string $end_date) Return the first Project filtered by the end_date column
 ...
 * @method array findByCoverProject(string $cover_project) Return Project objects filtered by the cover_project column
 * @method array findByStartDate(string $start_date) Return Project objects filtered by the start_date column
 * @method array findByEndDate(string $end_date) Return Project objects filtered by the end_date column
...
abstract class BaseProjectQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'Scrumbe\\Models\\Project';
        }
    ...
    /**
     * Filter the query on the url_name column
     *
     * Example usage:
     * <code>
     * $query->filterByUrlName('fooValue');   // WHERE url_name = 'fooValue'
     * $query->filterByUrlName('%fooValue%'); // WHERE url_name LIKE '%fooValue%'
     * </code>
     *
     * @param     string $urlName The value to use as filter.
     *              Accepts wildcards (* and % trigger a LIKE)
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ProjectQuery The current query, for fluid interface
     */
    public function filterByUrlName($urlName = null, $comparison = null)
    {
        if (null === $comparison) {
            if (is_array($urlName)) {
                $comparison = Criteria::IN;
            } elseif (preg_match('/[\%\*]/', $urlName)) {
                $urlName = str_replace('*', '%', $urlName);
                $comparison = Criteria::LIKE;
            }
        }

        return $this->addUsingAlias(ProjectPeer::URL_NAME, $urlName, $comparison);
    }
    ...
    /**
     * Filter the query on the cover_project column
     *
     * Example usage:
     * <code>
     * $query->filterByCoverProject('fooValue');   // WHERE cover_project = 'fooValue'
     * $query->filterByCoverProject('%fooValue%'); // WHERE cover_project LIKE '%fooValue%'
     * </code>
     *
     * @param     string $coverProject The value to use as filter.
     *              Accepts wildcards (* and % trigger a LIKE)
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ProjectQuery The current query, for fluid interface
     */
    public function filterByCoverProject($coverProject = null, $comparison = null)
    {
        if (null === $comparison) {
            if (is_array($coverProject)) {
                $comparison = Criteria::IN;
            } elseif (preg_match('/[\%\*]/', $coverProject)) {
                $coverProject = str_replace('*', '%', $coverProject);
                $comparison = Criteria::LIKE;
            }
        }

        return $this->addUsingAlias(ProjectPeer::COVER_PROJECT, $coverProject, $comparison);
    }
    ...
    public function filterByStartDate($startDate = null, $comparison = null)
    {
        if (is_array($startDate)) {
            ...
            if (isset($startDate['min'])) {
                $this->addUsingAlias(ProjectPeer::START_DATE, $startDate['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($startDate['max'])) {
                $this->addUsingAlias(ProjectPeer::START_DATE, $startDate['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ProjectPeer::START_DATE, $startDate, $comparison);
    }
    ...
    public function filterByEndDate($endDate = null, $comparison = null)
    {
        if (is_array($endDate)) {
            ...
            if (isset($endDate['min'])) {
                $this->addUsingAlias(ProjectPeer::END_DATE, $endDate['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($endDate['max'])) {
                $this->addUsingAlias(ProjectPeer::END_DATE, $endDate['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ProjectPeer::END_DATE, $endDate, $comparison);
    }
     ...
     *
     * @param   UserStory|PropelObjectCollection $userStory  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 ProjectQuery The current query, for fluid interface
    ...
    public function filterByUserStory($userStory, $comparison = null)
    {
        if ($userStory instanceof UserStory) {
            return $this
                ->addUsingAlias(ProjectPeer::ID, $userStory->getProjectId(), $comparison);
        } elseif ($userStory instanceof PropelObjectCollection) {
            return $this
                ->useUserStoryQuery()
                ->filterByPrimaryKeys($userStory->getPrimaryKeys())
                ->endUse();
        } else {
    ...
    public function filterByLinkProjectUser($linkProjectUser, $comparison = null)
    {
        if ($linkProjectUser instanceof LinkProjectUser) {
            return $this
                ->addUsingAlias(ProjectPeer::ID, $linkProjectUser->getProjectId(), $comparison);
